...
### 3) 자동 탐색 스크린샷 (제출물) ✅
리서치에 실제 인용한 출처 페이지를 headless Chrome으로 캡처: `docs/screenshots/`
- `02_letseoul_cafe_trend.png` (서울 봄 카페 트렌드 2026)
- `04_shopify_micro_influencer.png` (마이크로 인플루언서 전략)
- `05_sellerpic_instagram.png` (인스타 마케팅 가이드)
- `06_1point_micro.png` (마이크로 인플루언서 실전)
